...
// type Client struct {
// 	client pb.SigningRequestClient
// }
 
// func NewClient(conn grpc.ClientConnInterface) Client {
// 	return Client{
// 		client: pb.NewSigningRequestClient(conn),
// 	}
// }
 
func Upload(client pb.SigningRequestClient, ctx context.Context, file string) (string, error) {
